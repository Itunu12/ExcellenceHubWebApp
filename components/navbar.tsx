      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/pay" className="text-gray-700 hover:text-blue-600 font-medium transition-colors">
              Pricing
            </Link>
            ...
            {userData ? (
              <div className="flex items-center space-x-4">
                ...
                <Link href="/upload" className="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                  Upload
                </Link>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
              ...
              {userData ? (
                <>
                  ...
                  <div className="px-3 py-2 text-gray-700 font-medium">Welcome, {userData.firstName}!</div>
                  <button
                    onClick={() => {
                      handleLogout()
                      setIsOpen(false)
