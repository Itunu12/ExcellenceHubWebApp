...
const features = [
  {
    ...
    description:
      "Access thousands of past questions, lecture notes, textbooks, and study guides from (OOU) one of the top Nigerian university.",
  ...
  },
  {
    ...
    description:
      "Join a community of students sharing knowledge and helping each other succeed academically.",
  ...
  },
  {
    ...
    description:
      "Download resources instantly in various formats. Access your materials offline anytime, anywhere.",
  ...
  },
  {
    ...
    description:
      "All resources are verified and curated to ensure accuracy and relevance to your curriculum.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed">
              Access premium study resources, past questions, and educational
              materials from (OOU) one of the top Nigerian university. Join
              thousands of students achieving their academic goals.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-blue-100 text-blue-700">
              ✨ Why Choose ExcellenceHub
            </Badge>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Everything You Need to Succeed
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide comprehensive educational resources and tools designed
              specifically for Nigerian students.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="hover:shadow-2xl transition-all duration-500 border-0 shadow-lg"
              >
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100 leading-relaxed">
            Join StudyHub today and get instant access to premium educational
            resources that will transform your academic journey.
          </p>
