...
export default function AboutPage() {
  ...
  const stats = [
    ...
    { number: "1,000+", label: "Study Resources", icon: BookOpen },
    { number: "50+", label: "Universities Covered", icon: GraduationCap },
  ...
  const values = [
    {
      icon: Target,
      title: "Excellence",
      description: "We strive for the highest quality in everything we do, from content curation to user experience.",
    },
    {
      icon: Heart,
      title: "Community",
      description: "We believe in the power of students helping students and building a supportive learning community.",
    },
    {
      icon: Zap,
      title: "Innovation",
      description: "We continuously innovate to provide better tools and resources for academic success.",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">About StudyHub</h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto leading-relaxed">
              We're on a mission to democratize access to quality educational resources for university students across
              Nigeria.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Empowering Student Success</h2>
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                StudyHub was created to solve a common problem faced by university students across Nigeria - the
                difficulty in accessing quality study materials, past questions, and academic resources.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                We believe that every student deserves access to the resources they need to excel academically,
                regardless of their location or financial situation. That's why we've created a platform where students
                can easily find, purchase, and share academic materials.
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-lg text-gray-700 font-medium">Affordable pricing for all students</span>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="bg-green-100 p-2 rounded-full">
                    <CheckCircle className="h-6 w-6 text-green-600" />
                  </div>
                  <span className="text-lg text-gray-700 font-medium">Quality-assured content</span>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="bg-green-100 p-2 rounded-full">
                    <CheckCircle className="h-6 w-6 text-green-600" />
                  </div>
                  <span className="text-lg text-gray-700 font-medium">Supporting student entrepreneurs</span>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white shadow-2xl">
              ...
              <ul className="space-y-4">
                <li className="flex items-center">
                  ...
                  <span className="text-lg">Curated by top students and educators</span>
                </li>
                <li className="flex items-center">
                  <Star className="h-6 w-6 mr-4 text-yellow-300" />
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Comprehensive tools and resources in one place</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">StudyHub by the Numbers</h2>
            <p className="text-xl text-gray-600">Join thousands of students who trust StudyHub</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-yellow-100 text-yellow-700">⭐ Student Reviews</Badge>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">What Students Say</h2>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">How StudyHub Works</h2>
            <p className="text-xl text-gray-600">Simple steps to access premium academic resources</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Explore our extensive library of study materials, past questions, and textbooks from various
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Pay safely using our Paystack integration with support for cards, bank transfers, and mobile money.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Get instant access to your purchased materials and download them for offline study anytime, anywhere.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
            Join thousands of students who are already using StudyHub to achieve academic success.
          </p>
